...
<section class="py-20 lg:py-32 relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-20">
            ...
            {{-- Beneficio 2 --}}
            <div class="bg-white/80 rounded-3xl p-8 border border-white/50 hover:bg-white/90 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up" style="animation-delay: 0.8s;">
            ...
            {{-- Beneficio 3 --}}
            <div class="bg-white/80 rounded-3xl p-8 border border-white/50 hover:bg-white/90 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up" style="animation-delay: 1s;">
        ...
        <div class="bg-white/80 rounded-3xl p-12 lg:p-16 border border-white/50 mb-20 animate-fade-in-up" style="animation-delay: 1.2s;">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    ...
                    <a href="#" onclick="downloadCatalog()" class="group relative w-full bg-orange-500 text-white px-8 py-6 rounded-2xl font-bold text-lg text-center hover:bg-orange-600 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-orange-500/50 transform hover:-translate-y-1 overflow-hidden block">
                    ...
                    <a href="#" onclick="contactSales()" class="group relative w-full bg-blue-600 text-white px-8 py-6 rounded-2xl font-bold text-lg text-center hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-blue-500/50 transform hover:-translate-y-1 block">
                        <div class="flex items-center justify-center">
                            <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- WhatsApp Business --}}
                    <a href="https://wa.me/595123456789?text=Hola,%20estoy%20interesado%20en%20ser%20distribuidor%20de%20productos%20Dul-Cesar" target="_blank" class="group relative w-full bg-green-500 text-white px-8 py-6 rounded-2xl font-bold text-lg text-center hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-green-500/50 transform hover:-translate-y-1 block">
                        <div class="flex items-center justify-center">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            <div class="text-center bg-white/80 rounded-2xl p-6 border border-white/50 animate-fade-in-up" style="animation-delay: 1.4s;">
                <div class="text-4xl lg:text-5xl font-bold text-black mb-2">200+</div>
                <div class="text-gray-700 font-medium">Productos</div>
            </div>
            <div class="text-center bg-white/80 rounded-2xl p-6 border border-white/50 animate-fade-in-up" style="animation-delay: 1.6s;">
                <div class="text-4xl lg:text-5xl font-bold text-black mb-2">50+</div>
                <div class="text-gray-700 font-medium">Distribuidores</div>
            </div>
            <div class="text-center bg-white/80 rounded-2xl p-6 border border-white/50 animate-fade-in-up" style="animation-delay: 1.8s;">
                <div class="text-4xl lg:text-5xl font-bold text-black mb-2">15+</div>
                <div class="text-gray-700 font-medium">Años Experiencia</div>
            </div>
            <div class="text-center bg-white/80 rounded-2xl p-6 border border-white/50 animate-fade-in-up" style="animation-delay: 2s;">
                <div class="text-4xl lg:text-5xl font-bold text-black mb-2">100%</div>
                <div class="text-gray-700 font-medium">Calidad</div>
            </div>
        </div>

        {{-- CTA Final --}}
        <div class="text-center bg-white/80 rounded-2xl p-8 border border-white/50 animate-fade-in-up" style="animation-delay: 2.2s;">
            <p class="text-lg text-gray-700 mb-6">
                ¿Tienes preguntas? Nuestro equipo comercial está listo para ayudarte
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:ventas@dulcesar.com" class="inline-flex items-center text-orange-600 hover:text-orange-700 transition-colors duration-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    ventas@dulcesar.com
                </a>
                <a href="tel:+595123456789" class="inline-flex items-center text-orange-600 hover:text-orange-700 transition-colors duration-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    </svg>
                    +595 123 456 789
...
<style>
    ...
    /* Efectos de borde con transparencia */
    .border-white\/30 {
