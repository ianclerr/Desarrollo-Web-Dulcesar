    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="text-center mb-16 reveal-on-scroll">
            <h4 class="font-display text-4xl lg:text-5xl font-bold text-gray-800 mb-6">
                Nuestro <span class="text-orange-600">Contacto</span>
            </h4>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {{-- Televentas --}}
                <div class="contact-card bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
                    <div class="text-center">
                        ...
                        <h5 class="text-2xl font-bold text-gray-800 mb-4">Televentas</h5>
                        <p class="text-gray-600 mb-6">Para consultas sobre productos y realizar pedidos</p>
                        <div class="space-y-3">
                ...
                <div class="contact-card bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
                    <div class="text-center">
                        ...
                        <h5 class="text-2xl font-bold text-gray-800 mb-4">Atención al Cliente</h5>
                        <p class="text-gray-600 mb-6">Soporte técnico y resolución de consultas</p>
                        <div class="space-y-3">
                ...
                <div class="contact-card bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
                    <div class="text-center">
                        ...
                        <h5 class="text-2xl font-bold text-gray-800 mb-4">Recursos Humanos</h5>
                        <p class="text-gray-600 mb-6">Oportunidades laborales y consultas de personal</p>
                        <div class="space-y-3">
                ...
                <div class="contact-card bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
                    <div class="text-center">
                        ...
                        <h5 class="text-2xl font-bold text-gray-800 mb-4">Marketing</h5>
                        <p class="text-gray-600 mb-6">Alianzas estratégicas y campañas publicitarias</p>
                        <div class="space-y-3">
                ...
                {{-- Redes Sociales --}}
                <div class="contact-card bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 md:col-span-2 lg:col-span-1">
                    <div class="text-center">
                        ...
                        <h5 class="text-2xl font-bold text-gray-800 mb-4">Redes Sociales</h5>
                        <p class="text-gray-600 mb-6">Síguenos y mantente conectado con nosotros</p>
            ...
            {{-- Información General --}}
            <div class="mt-16 bg-white rounded-3xl p-8 shadow-2xl hover:shadow-orange-500/10 transition-all duration-500">
                <div class="text-center">
                    <h5 class="text-3xl font-bold text-gray-800 mb-6">Información General</h5>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <p class="text-gray-600"><br>Celsa Speratti y de la honestidad 1372</p>
                        </div>
                        <div>
                            ...
                            <p class="text-gray-600">07:00h - 17:00h</p>
                        </div>
                        <div>
                            ...
                            <p class="text-gray-600">info@dulcesar.com</p>
                        </div>
                    </div>
                </div>
            </div>
